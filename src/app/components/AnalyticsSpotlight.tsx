  ...
  return (
    <section className="w-full mt-8 mb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="rounded-3xl p-5 flex flex-col gap-4" style={{ background: "#0d1117", border: "1px solid rgba(201,123,58,0.2)", boxShadow: "0 8px 40px rgba(0,0,0,0.15)" }}>
          ...
          <div className="rounded-2xl p-4" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}>
            <p className="text-sm font-bold mb-3" style={{ color: "#fdf8f3" }}>Monthly Comparison</p>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs" style={{ color: "rgba(253,248,243,0.4)" }}>This Month</p>
                <p className="text-2xl font-black" style={{ color: "#fdf8f3" }}>47</p>
              ...
              <div className="text-right">
                ...
                <p className="text-2xl font-black" style={{ color: "rgba(253,248,243,0.45)" }}>32</p>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="rounded-2xl p-3.5" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}>
              ...
              <p className="text-2xl font-black" style={{ color: "#fdf8f3" }}>284</p>
            ...
            <div className="rounded-2xl p-3.5" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}>
              ...
              <p className="text-2xl font-black" style={{ color: "#fdf8f3" }}>221</p>
              <div className="flex items-center justify-between mt-1">
            ...
            <div className="rounded-2xl p-3.5" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}>
              ...
              <p className="text-2xl font-black" style={{ color: "#fdf8f3" }}>34</p>
              <div className="flex items-center justify-between mt-1">
            ...
            <div className="rounded-2xl p-3.5" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}>
              ...
              <p className="text-2xl font-black" style={{ color: "#fdf8f3" }}>9</p>
              <div className="flex items-center justify-between mt-1">
