    ...
    >
      ...
      <div className="absolute inset-0 z-10 flex items-center justify-center pointer-events-none">
        ...
        <div
          ...
          style={{
            ...
            animation: "hb-ring-spin 18s linear infinite",
          }}
        >
          {/* Orbiting dot */}
          <div
            ...
            style={{
              ...
              left: "50%",
              transform: "translateX(-50%)",
              background: "radial-gradient(circle, #f5b97a, #c97b3a)",
              boxShadow: "0 0 12px rgba(232,148,74,0.8)",
            }}
          />
        </div>
        ...
        <div
          ...
          style={{
            ...
            height: "240px",
            border: "1px solid rgba(201,123,58,0.2)",
            animation: "hb-ring-spin-rev 12s linear infinite",
          }}
        >
          {/* Orbiting dot 2 */}
          <div
            ...
            style={{
              ...
              left: "50%",
              transform: "translateX(-50%)",
              background: "radial-gradient(circle, #e8944a, #9b5a1a)",
              boxShadow: "0 0 8px rgba(201,123,58,0.7)",
            }}
          />
        </div>
        ...
        <div
          ...
          style={{
            ...
            animation: "hb-ring-pulse 3s ease-in-out infinite",
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            height: "128px",
            background:
              "radial-gradient(circle at 35% 35%, rgba(201,123,58,0.35) 0%, rgba(12,12,18,0.95) 65%)",
            border: "1.5px solid rgba(201,123,58,0.45)",
            boxShadow:
              "0 0 0 8px rgba(201,123,58,0.06), 0 0 40px rgba(201,123,58,0.25), 0 0 80px rgba(201,123,58,0.1)",
          }}
        >
          {/* Inner shine */}
          <div
          ...
          <Image
            ...
            style={{
              filter: "drop-shadow(0 0 12px rgba(232,148,74,0.6))",
              borderRadius: "12px",
            }}
            priority
          />
        ...
        {[
          { size: 4, top: "22%", left: "28%", delay: "0s", dur: "5.5s" },
          { size: 3, top: "65%", left: "68%", delay: "1.2s", dur: "6.5s" },
          { size: 5, top: "75%", left: "32%", delay: "2.1s", dur: "5s" },
          { size: 3, top: "30%", left: "70%", delay: "0.7s", dur: "7s" },
          { size: 4, top: "50%", left: "22%", delay: "3s", dur: "4.5s" },
          { size: 3, top: "18%", left: "58%", delay: "1.8s", dur: "6s" },
        ].map((p, i) => (
          <div
            key={i}
            ...
            style={{
              ...
              boxShadow: "0 0 6px rgba(232,148,74,0.5)",
              animation: `hb-particle ${p.dur} ease-in-out ${p.delay} infinite`,
            }}
          />
        ))}
      </div>
      ...
      <style>{`
        ...
        @keyframes hb-particle {
          ...
          30%       { opacity: 0.9; }
          50%       { opacity: 0.6; transform: translateY(-14px) scale(1.2); }
          80%       { opacity: 0.3; }
        }
      `}</style>
    </div>
