...
export const ShootingStars: React.FC<ShootingStarsProps> = ({
  ...
  // Unique gradient ID per instance so multiple ShootingStars don't clobber each other
  const gradientId = useRef(`sg-${Math.random().toString(36).slice(2, 8)}`).current;
