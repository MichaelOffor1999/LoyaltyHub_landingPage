...
export default function IntroAnimation() {
    ...
    useEffect(() => {
        ...
        const handleWheel = (e: WheelEvent) => {
            ...
            // If scrolling down and already at max, allow page scroll
            // If scrolling up and already at 0, allow page scroll
            const isAtMax = currentScroll >= MAX_SCROLL;
            const isAtMin = currentScroll <= 0;
            const isScrollingDown = delta > 0;
            const isScrollingUp = delta < 0;
            
            if ((isAtMax && isScrollingDown) || (isAtMin && isScrollingUp)) {
                // Allow natural page scroll
                return;
            }
            
            // Prevent default to handle scroll within this section
            e.preventDefault();
    ...
    // --- Multi-stage Text Animations ---
    // Stage 1: Main headline (scroll 0-800)
    const stage1Opacity = useTransform(virtualScroll, [0, 300, 800, 1200], [1, 1, 1, 0]);
    
    // Stage 2: Feature highlights (scroll 800-1500)
    const stage2Opacity = useTransform(virtualScroll, [700, 900, 1300, 1500], [0, 1, 1, 0]);
    
    // Stage 3: Call to action (scroll 1300-1800)
    const stage3Opacity = useTransform(virtualScroll, [1200, 1400, 1600, 1800], [0, 1, 1, 0]);
    ...
    return (
        ...
        >
            ...
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                {/* Stage 1: Main Value Proposition */}
                <motion.div
                    style={{ opacity: stage1Opacity }}
                    className="absolute top-[12%] z-10 flex flex-col items-center justify-center text-center pointer-events-none px-4 max-w-4xl"
                >
                    <h2 
                    ...
                    <p 
                        className="text-base md:text-xl max-w-2xl leading-relaxed mb-6"
                        style={{ color: "#374151", fontWeight: 600 }}
                    >
                        The modern loyalty platform that makes every interaction count.
                        Track visits, reward behavior, and watch your customers keep coming back.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 items-center justify-center text-sm md:text-base">
                        <div className="flex items-center gap-2">
                            <span className="text-2xl">📱</span>
                            <span style={{ color: "#6b7280", fontWeight: 600 }}>Mobile-First Experience</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <span className="text-2xl">📊</span>
                            <span style={{ color: "#6b7280", fontWeight: 600 }}>Real-Time Analytics</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <span className="text-2xl">🎁</span>
                            <span style={{ color: "#6b7280", fontWeight: 600 }}>Automated Rewards</span>
                        </div>
                    </div>
                </motion.div>

                {/* Stage 2: Feature Highlights */}
                <motion.div
                    style={{ opacity: stage2Opacity }}
                    className="absolute top-[15%] z-10 flex flex-col items-center justify-center text-center pointer-events-none px-4 max-w-5xl"
                >
                    <div
                        className="inline-block rounded-full px-4 py-2 text-sm font-bold mb-6"
                        style={{
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl">
                        <div className="flex flex-col items-center">
                            <div 
                                ...
                                style={{ background: "rgba(201,123,58,0.1)" }}
                            >
                                ☕
                            </div>
                            ...
                            <p className="text-sm" style={{ color: "#6b7280", fontWeight: 500 }}>
                                Digital punch cards that work instantly at checkout
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-sm" style={{ color: "#6b7280", fontWeight: 500 }}>
                                Book, reward, and retain beauty & wellness clients
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-sm" style={{ color: "#6b7280", fontWeight: 500 }}>
                                Points, tiers, and exclusive perks for shoppers
                            </p>
                        </div>
                    </div>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="absolute top-[20%] z-10 flex flex-col items-center justify-center text-center pointer-events-none px-4 max-w-3xl"
                >
                    <h2 
                    ...
                    <p 
                        className="text-lg md:text-xl max-w-2xl leading-relaxed mb-6"
                        style={{ color: "#374151", fontWeight: 600 }}
                    >
                        Join hundreds of businesses already using Clienty to increase customer retention by up to <span style={{ color: "#c97b3a", fontWeight: 700 }}>3x</span>
                    </p>
                    <div className="flex flex-col gap-3">
                        <div className="flex items-center gap-2 text-base" style={{ color: "#6b7280", fontWeight: 600 }}>
                            <span style={{ color: "#c97b3a", fontSize: "1.5rem" }}>✓</span>
