...
function TestimonialCard({
  ...
  content =
    "This is amazing! 🔥 Absolutely loving what the team is building here. Can't wait to see what comes next!",
  date = "Jan 5, 2026",
  verified = true,
  likes = 142,
  retweets = 23,
  ...
  const defaultCards: TestimonialCardProps[] = [
    {
      ...
      handle: "@sarahchen",
      content:
        "This component is exactly what I needed for my landing page. The stacked effect is beautiful and feels premium.",
      date: "Jan 3, 2026",
      verified: true,
      likes: 42,
      retweets: 8,
    ...
    },
    {
      ...
      handle: "@mikej_dev",
      content:
        "The hover interactions are so smooth. Love how the cards spread apart to reveal the ones behind.",
      date: "Jan 2, 2026",
      verified: true,
      likes: 28,
      retweets: 5,
    ...
    },
    {
      ...
      handle: "@alexrivera",
      content:
        "Finally a testimonial component that looks native to Twitter/X! Dark mode support is chef's kiss.",
      date: "Jan 1, 2026",
      verified: true,
      likes: 156,
      retweets: 23,
