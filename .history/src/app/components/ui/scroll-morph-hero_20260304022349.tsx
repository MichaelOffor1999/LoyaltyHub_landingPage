...
// Loyalty card UI mock images (matches the 'loyalty card' look in your screenshots)
// Using a mix of local/public assets so they're guaranteed to load without remote config.
const IMAGES = [
    "/og-image.png",
    "/rounder_edges.PNG",
    "/og-image.png",
