...
import { ArrowRight, Link, Coffee, Dumbbell, Scissors, UtensilsCrossed, Sparkles, ShoppingBag, Car, Leaf, PawPrint, Flower2 } from "lucide-react";
          ...
          {timelineData.map((item) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={[
                    "absolute top-16 whitespace-nowrap text-xs font-semibold tracking-wider transition-all duration-300",
                ...
                {/* Expanded info card */}
                {isExpanded && (
                  <Card className="absolute top-24 left-1/2 -translate-x-1/2 w-64 bg-black/90 backdrop-blur-lg border-white/20 shadow-xl shadow-black/50 overflow-visible">
