  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={`${inter.variable} antialiased`}>
        <ThemeProvider>
          {/* Global flow-field neural background — dark mode only, behind everything */}
          <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none" style={{ mixBlendMode: "screen" }}>
            <FlowFieldBackground />
          </div>
          {/* Global shooting stars — fixed behind all content, hidden in light mode via CSS */}
