...
import { Coffee, Dumbbell, Scissors, UtensilsCrossed, Sparkles, ShoppingBag, Car, Leaf, PawPrint, Flower2 } from "lucide-react";

const HERO_ORBIT_DATA = [
  { id: 1, title: "Coffee Shops",   date: "Most Popular",   content: "Stamp cards that fill up fast — earn a free coffee every 5 visits.", category: "Food",     icon: Coffee,           relatedIds: [4, 7], status: "completed"   as const, energy: 95 },
  { id: 2, title: "Gyms",           date: "High Retention", content: "Reward attendance streaks and reduce churn by 40%.",                 category: "Health",   icon: Dumbbell,         relatedIds: [9, 3], status: "completed"   as const, energy: 88 },
  { id: 3, title: "Salons",         date: "Repeat Bookings",content: "Every 6th cut is on you — fills your calendar automatically.",       category: "Beauty",   icon: Scissors,         relatedIds: [5, 2], status: "completed"   as const, energy: 82 },
  { id: 4, title: "Restaurants",    date: "High Volume",    content: "Turn one-time diners into weekly regulars with birthday perks.",     category: "Food",     icon: UtensilsCrossed,  relatedIds: [1, 7], status: "in-progress" as const, energy: 90 },
  { id: 5, title: "Nail & Beauty",  date: "Loyal Champions",content: "Clients who earn rewards come back 3× more.",                       category: "Beauty",   icon: Sparkles,         relatedIds: [3, 6], status: "completed"   as const, energy: 78 },
  { id: 6, title: "Boutiques",      date: "Growing Fast",   content: "Spend-based loyalty — shoppers with points spend 27% more.",        category: "Retail",   icon: ShoppingBag,      relatedIds: [5, 8], status: "in-progress" as const, energy: 70 },
  { id: 7, title: "Bakeries",       date: "Morning Ritual", content: "A free loaf on the 10th visit creates a habit that sticks.",        category: "Food",     icon: Leaf,             relatedIds: [1, 4], status: "completed"   as const, energy: 85 },
  { id: 8, title: "Car Washes",     date: "Quick Wins",     content: "Stamp cards drive consistent monthly revenue.",                     category: "Auto",     icon: Car,              relatedIds: [6],    status: "in-progress" as const, energy: 65 },
  { id: 9, title: "Spas",           date: "Premium Clients",content: "Tier-based loyalty keeps your VIPs feeling seen.",                  category: "Wellness", icon: Flower2,          relatedIds: [2, 10],status: "completed"   as const, energy: 80 },
  { id: 10, title: "Pet Groomers",  date: "Loyal Owners",   content: "A free groom after 6 visits makes you their only choice.",          category: "Pets",     icon: PawPrint,         relatedIds: [9],    status: "pending"     as const, energy: 60 },
];
    ...
    <div className="min-h-screen font-sans" style={{ background: "transparent" }}>
      ...
      <main id="main-content" className="w-full max-w-5xl mx-auto flex flex-col items-center px-6 relative z-10">
        ...
        <section id="top" className="w-full pt-20 pb-10">
          <ScrollReveal staggerChildren className="w-full flex flex-col lg:flex-row items-center lg:items-start lg:justify-between gap-12 lg:gap-8 text-center lg:text-left">
            {/* Left: text + CTA */}
            ...
            {/* Right: orbiting industry circles */}
            <div className="shrink-0 flex items-center justify-center w-full lg:w-[480px]">
              <RadialOrbitalTimeline timelineData={HERO_ORBIT_DATA} />
            </div>
          </ScrollReveal>
