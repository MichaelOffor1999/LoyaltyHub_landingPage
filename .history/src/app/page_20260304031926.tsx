  ...
  return (
    <div className="min-h-screen font-sans" style={{ background: "transparent" }}>
      ...
      <main id="main-content" className="w-full max-w-5xl mx-auto flex flex-col items-center px-6 relative z-10">
        ...
        {/* Hero */}
        <section id="top" className="w-full pt-16 pb-10">
          <div className="w-full flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">

            {/* ── Left: copy + CTA ── */}
            <ScrollReveal staggerChildren className="flex flex-col items-start text-left max-w-xl w-full">
              <div
              ...
              <p className="text-lg sm:text-xl leading-snug mb-8" style={{ color: "var(--text-sub)", fontWeight: 500 }}>
            ...
            <ScrollReveal className="hidden lg:flex shrink-0 items-center justify-center py-12 pr-8">
              <HowItWorksCards />
            </ScrollReveal>
        ...
        >
          ...
          {/* Desktop: step list centred — cards now live in the hero */}
