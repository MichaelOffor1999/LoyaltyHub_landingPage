    ...
    <div className="min-h-screen font-sans" style={{ background: "transparent" }}>
      ...
      <main id="main-content" className="w-full max-w-5xl mx-auto flex flex-col items-center px-6 relative z-10">
        ...
        >
          ...
          <ScrollReveal className="sm:hidden" variant="fade-up" threshold={0.06}>
          ...
          <ScrollReveal className="hidden sm:flex items-center justify-center gap-16 lg:gap-24" staggerChildren variant="fade-left" staggerBase={150}>
            {/* Left: stacked cards */}
